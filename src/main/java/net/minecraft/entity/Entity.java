...
import cc.zork.event.SafeWalkEvent;
import cc.zork.event.StepConfirmEvent;
import cc.zork.event.StepEvent;
    ...
    public void moveEntity(double x, double y, double z) {
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0F && flag1 && (d3 != x || d5 != z)) {
                ...
                EventManager.Companion.callEvent(stepEvent);
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                if (d11 * d11 + d8 * d8 >= x * x + z * z) {
                    ...
                    EventManager.Companion.callEvent(new StepConfirmEvent());
                }
            }
