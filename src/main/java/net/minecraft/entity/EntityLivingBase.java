...
import cc.zork.Zork;
import cc.zork.event.JumpEvent;
...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        ...
        if ((this.equals(Minecraft.getMinecraft().thePlayer)) && ModuleManager.getMod(BlockAnimation.class).getStage()) {
            speed = (int) (speed * (BlockAnimation.Companion.getSwingSpeed().getValue().floatValue()));
        }
        return speed;
    }
    ...
    protected void jump() {
        ...
        EventManager.Companion.callEvent(new JumpEvent(getJumpUpwardsMotion()));
