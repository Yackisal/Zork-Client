...
import cc.zork.Zork;
import cc.zork.features.player.ChestStealer;
...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this instanceof GuiChest && ModuleManager.getMod(ChestStealer.class).getStage() && ChestStealer.Companion.getNoGui().getCurrent()) {
            ScaledResolution sr = new ScaledResolution(this.mc);
            FontManager.normal.drawFontShadow("Stealing...", sr.getScaledWidth() / 2f - FontManager.normal.getStringWidth("Stealing...") / 2, sr.getScaledHeight() / 2f, -1);
