...
import cc.zork.features.ui.BetterHotbar;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (!ModuleManager.getMod(BetterHotbar.class).getStage())
...
//                GlStateManager.scale(4.0F, 4.0F, 4.0F);
                ...
                FontManager.biggest.drawString(this.displayedTitle, (float) (-FontManager.biggest.getStringWidth(this.displayedTitle) / 2), -30.0F, 16777215 | j2, true);
...
//                GlStateManager.scale(2.0F, 2.0F, 2.0F);
                FontManager.big.drawString(this.displayedSubTitle, (float) (-FontManager.big.getStringWidth(this.displayedSubTitle) / 2), 0.0F, 16777215 | j2, true);
//                this.getFontRenderer().drawString(this.displayedSubTitle, (float)(-this.getFontRenderer().getStringWidth(this.displayedSubTitle) / 2), 5.0F, 16777215 | j2, true);
        ...
        if (scoreobjective1 != null) {
            if(ModuleManager.getMod(cc.zork.features.ui.Scoreboard.class).getStage()){
                cc.zork.features.ui.Scoreboard.Companion.renderScoreboard(scoreobjective1, scaledresolution);
            }else {
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks) {
        ...
        if (this.mc.getRenderViewEntity() instanceof EntityPlayer && !ModuleManager.getMod(BetterHotbar.class).getStage()) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        HUD.Companion.shader();
        EventManager.Companion.callEvent(new Render2DEvent(partialTicks));
    ...
    private void renderScoreboard(ScoreObjective objective, ScaledResolution scaledRes) {
        ...
        for (Score score1 : collection) {
            ...
            // match all emojis in string s1 and remove them
            Matcher matcher = Pattern.compile("[\uD83C-\uDBFF\uDC00-\uDFFF]+").matcher(s1);
            // if there is at least one emoji
            if (matcher.find()) {
                // remove all emojis
            ...
            fontRenderer.drawStringWithShadow(s1, l1, k, -1);
            fontRenderer.drawString(s2, l - fontRenderer.getStringWidth(s2), k, -1);
            if (j == collection.size()) {
                String s3 = objective.getDisplayName();
                drawRect(l1 - 2, k - fontRenderer.FONT_HEIGHT - 1, l, k - 1, 1610612736);
                drawRect(l1 - 2, k - 1, l, k, 1342177280);
                fontRenderer.drawString(s3, l1 + i / 2 - fontRenderer.getStringWidth(s3) / 2, k - fontRenderer.FONT_HEIGHT, -1);
            }
        }
    }
