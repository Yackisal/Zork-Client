...
import cc.zork.features.render.NameTags;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        try {
            ...
            if (entity instanceof EntityPlayer) {
                RenderEntityLivingEvent pre = new RenderEntityLivingEvent(EventType.PRE,entity,  f6, f5, f7, f2, f8, f, f4);
                EventManager.Companion.callEvent(pre);
        ...
        RenderEntityLivingEvent post = new RenderEntityLivingEvent(EventType.POST,entity);
        EventManager.Companion.callEvent(post);
    }
    ...
    public void renderName(T entity, double x, double y, double z) {
        if(ModuleManager.getMod(NameTags.class).getStage() && entity instanceof EntityPlayer)
            return;
