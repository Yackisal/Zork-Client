...
import cc.zork.features.combat.Reach;
...
import static cc.zork.features.combat.Teams.noTeamHit;
...
public class EntityRenderer implements IResourceManagerReloadListener {
    ...
    public void getMouseOver(float partialTicks) {
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (ModuleManager.getMod(Reach.class).getStage() ? Reach.Companion.getReach().get().doubleValue() : 3.0D)) {
                this.pointedEntity = null;
            ...
            if (this.pointedEntity != null && (d2 < d1 || this.mc.objectMouseOver == null)) {
                ...
                if (this.pointedEntity instanceof EntityLivingBase || this.pointedEntity instanceof EntityItemFrame) {
                    if (ModuleManager.getMod(Teams.class).getStage() && Teams.noTeamHit.getCurrent() && pointedEntity instanceof EntityLivingBase) {
                        if (!Teams.Companion.isInSameTeam(((EntityLivingBase) pointedEntity))) {
...
//            }
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
        ...
        GlStateManager.alphaFunc(516, 0.1F);
        EventManager.Companion.callEvent(new Render3DEvent(EventType.PRE, partialTicks));
        ...
        EventManager.Companion.callEvent(new Render3DEvent(EventType.POST, partialTicks));
