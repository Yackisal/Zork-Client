...
import cc.zork.features.render.BlockAnimation;
...
public class ItemRenderer {
    ...
    public void renderItemInFirstPerson(float partialTicks) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand()) {
            ...
            if (this.itemToRender != null) {
                if (this.itemToRender.getItem() instanceof ItemMap) {
                ...
                } else if (abstractclientplayer.getItemInUseCount() > 0 || (KillAura.Companion.getTarget() != null && KillAura.Companion.getAutoblock().getCurrent()) && (mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {
                    ...
                    switch (enumaction) {
                        ...
                        case BLOCK:
                            if (ModuleManager.getMod(BlockAnimation.class).getStage()) {
    ...
    private void renderingBlocked(float swingProgress, float equippedProgress) {
        ...
        GL11.glTranslated(BlockAnimation.Companion.getPosX().getValue().floatValue(), BlockAnimation.Companion.getPosY().getValue().floatValue(), BlockAnimation.Companion.getPosZ().getValue().floatValue());
        if (BlockAnimation.Companion.getMode().getCurrent().equals("Sigma")) {
        ...
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("1.7")) {
            this.transformFirstPersonItem(swingProgress - 0.3F, equippedProgress);
            this.doBlockTransformations();
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("Swang")) {
            ...
            this.doBlockTransformations();
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("Swank")) {
            this.transformFirstPersonItem(swingProgress / 2.0F, equippedProgress);
            float var15;
            ...
            this.doBlockTransformations();
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("Swong")) {
            ...
            this.doBlockTransformations();
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("Hanabi")) {
        ...
        } else if (BlockAnimation.Companion.getMode().getCurrent().equals("Jello")) {
            GlStateManager.translate(0.56F, -0.52F, -0.71999997F);
