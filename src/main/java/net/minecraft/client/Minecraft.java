...
import cc.zork.Zork;
import cc.zork.event.BlockClickEvent;
import cc.zork.event.KeyEvent;
import cc.zork.event.TickEvent;
import cc.zork.event.WorldEvent;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Zork.fontManager = new FontManager();
//        Zork.luaManager = new LuaManager();
//        Zork.luaManager.loadScripts();
    }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle(Zork.CLIENT_NAME + " " + Zork.CLIENT_VERSION);
    ...
    private void runGameLoop() throws IOException {
        EventManager.Companion.callEvent(new TickEvent());
    ...
    private void rightClickMouse() {
        if (!this.playerController.getIsHittingBlock()) {
            ...
            if (this.objectMouseOver == null) {
                ...
                BlockClickEvent event = new BlockClickEvent(this.objectMouseOver);
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    case BLOCK:
                        ...
                        BlockPos blockpos = event.getObj().getBlockPos();

                        if (this.theWorld.getBlockState(blockpos).getBlock().getMaterial() != Material.air) {
                            int i = itemstack != null ? itemstack.stackSize : 0;

                            if (this.playerController.onPlayerRightClick(this.thePlayer, this.theWorld, itemstack, blockpos, event.getEnumFacing(), event.getObj().hitVec)) {
                                flag = false;
                                this.thePlayer.swingItem();
                            }
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    EventManager.Companion.callEvent(new KeyEvent(k));
    ...
    public void loadWorld(WorldClient worldClientIn, String loadingMessage) {
        EventManager.Companion.callEvent(new WorldEvent(worldClientIn));
